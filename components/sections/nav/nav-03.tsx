  ...
  return (
    <header className="sticky top-0 z-50 border-b border-border bg-background">
      <nav className="mx-auto grid h-20 max-w-7xl grid-cols-[1fr_auto_1fr] items-center gap-6 px-6">
        ...
        <Link href="/" className="cursor-pointer justify-self-start text-center focus-visible:ring-2 focus-visible:ring-primary focus-visible:outline-none md:justify-self-center">
