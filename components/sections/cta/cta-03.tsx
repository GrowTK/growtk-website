...
export function Cta03({ heading, primary, secondary, image, points = [], footnote }: {
  ...
  return (
    <section className="relative isolate overflow-hidden bg-background py-20 lg:py-24">
      {/* Sparingly, on a mid-page CTA only, per design law: a static blurred glow, not a moving aurora. */}
      <div aria-hidden className="pointer-events-none absolute top-1/2 left-1/2 size-[42rem] -translate-x-1/2 -translate-y-1/2 rounded-full bg-primary/[0.06] blur-3xl" />
      <div className="relative mx-auto max-w-7xl px-6">
        <Reveal>
          <div className="grid overflow-hidden rounded-2xl border border-border shadow-xl lg:grid-cols-2">
