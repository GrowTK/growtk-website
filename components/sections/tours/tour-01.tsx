...
import { BookTrigger } from "@/components/booking/book-trigger";
                ...
                <div className="mt-3.5">
                  <div className="flex items-start justify-between gap-3">
                    <h3 className="font-display text-base font-semibold tracking-tight text-foreground">
                      <BookTrigger
                        activity={t}
                        className="text-left after:absolute after:inset-0 focus-visible:ring-2 focus-visible:ring-ring focus-visible:outline-none"
                      >
                        {t.title}
                      </BookTrigger>
                    </h3>
