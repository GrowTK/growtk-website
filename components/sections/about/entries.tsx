...
export const ABOUT_ENTRIES: CatalogEntry[] = [
  {
    code: "ABOUT-01",
    category: "About",
    label: "A single measured column of body copy with an oversized drop cap opening the first paragraph and one wide photo breaking the text partway down. Best for a founder led business with one continuous origin story to tell, where the writing itself, not stats or a team roster, is the selling point.",
  ...
  },
  {
    code: "ABOUT-02",
    category: "About",
    label: "Two column split: narrative copy on the left, a hairline separated 2x2 stat block with a footnote on the right. Best for an operation that wants to back up its story with hard numbers, like years running, guests served, or a licence count, rather than lean on story alone.",
  ...
  },
  {
    code: "ABOUT-03",
    category: "About",
    label: "A vertical milestone rail with the year set in the margin and a dot per entry, alternating sides of the timeline on desktop. Best for a business with a real multi-year history and a handful of named turning points to walk through in order, not for a young company with nothing yet to look back on.",
  ...
  },
  {
    code: "ABOUT-04",
    category: "About",
    label: "Three photos in an asymmetric, slightly rotated stack beside a copy column that ends in a call to action button. Best for a business with strong day in the life photography that wants that imagery, not a stat block or timeline, to carry the credibility, while still pushing the reader toward a next step.",
  ...
  },
  {
    code: "ABOUT-05",
    category: "About",
    label: "A long lead paragraph atop a dark inverted panel, followed by numbered value cards, no people or photos involved. Best for a business making the case for its principles or philosophy, the rules it will not break, rather than telling a chronological story or introducing named staff.",
  ...
  },
  {
    code: "TEAM-01",
    category: "Team",
    label: "A square portrait grid up to four across, where each member's bio stays hidden until you hover or tab to their card. Best for a larger team, six or more, that needs a compact scannable roster without every bio competing for space at once.",
  ...
  },
  {
    code: "TEAM-02",
    category: "Team",
    label: "Full width editorial rows pairing a large portrait with a display sized name, alternating left and right with a hairline rule between each. Best for a small leadership team, three or four key people, where each person gets a generous magazine style introduction.",
  ...
  },
  {
    code: "TEAM-03",
    category: "Team",
    label: "A tight row of circular portraits where a bio card, with a row of social links, pops up above the photo on hover or focus. Best for a team that wants to feel personally reachable, each member effectively offering their own contact card, in a compact horizontal strip.",
  ...
  },
  {
    code: "TEAM-04",
    category: "Team",
    label: "Overlapping, rotated cards on a bold colour band that each straighten out on hover or keyboard focus. Best for a casual, high energy brand that wants its crew introduction to feel playful and tactile rather than corporate.",
  ...
  },
  {
    code: "TEAM-05",
    category: "Team",
    label: "A compact directory table with mono column headers, a role and 'known for' column, and a mail icon per row. Best for a business where visitors need to know exactly who to contact and about what, a utility minded roster rather than a storytelling one, and it scales cleanly to a longer staff list.",
